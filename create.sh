...
aws cloudformation create-stack --stack-name WAFTsting --template-body file://${PWD}/cf/sqli-tsting.yml --parameters ParameterKey=OperatorWANIP,ParameterValue=${OperatorWANIP}
aws cloudformation wait stack-create-complete --stack-name WAFTsting
